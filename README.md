...
8. En terminal flask db init
9. En terminal flask db migrate -m "Inicializacion desde cero"
10. En terminal flask db upgrade
11. Ejecutar app.py
12. Verificar el inicio de Flask
13. Usar el comando: cd ..
14. Usar el comando: cd app
15. Usar el comando: npm install
16. Usar el comando: npm run dev
17. Entrar al link: http://localhost:5173/
