...
          <p className="hover:text-white cursor-pointer transition-colors py-1" onClick={() => navigateTo('programacion_avanzada')}>Programacion Avanzada</p>
        </div>
      </div>
...
          <div className="ml-5 mt-2 space-y-1 text-gray-400 text-sm">
          <p className="hover:text-white cursor-pointer transition-colors py-1" onClick={() => navigateTo('hito1')}>Hito1</p>
          <p className="hover:text-white cursor-pointer transition-colors py-1" onClick={() => navigateTo('taller1')}>Taller1</p>
        </div>
        
        {/* Tareas */}
        <NavItem icon="📋" name="Tareas" hasPlus={true} onClick={() => navigateTo('tareas_general')} />
                  <div className="ml-5 mt-2 space-y-1 text-gray-400 text-sm">
          <p className="hover:text-white cursor-pointer transition-colors py-1" onClick={() => navigateTo('tarea_gantt')}>Crear Carta Gantt</p>
          <p className="hover:text-white cursor-pointer transition-colors py-1" onClick={() => navigateTo('tarea_desarrollo')}>Desarrollo Funcionalidades</p>
          <p className="hover:text-white cursor-pointer transition-colors py-1" onClick={() => navigateTo('tarea_exposicion')}>Diseñar Exposición oral</p>
        </div>
      </div>
